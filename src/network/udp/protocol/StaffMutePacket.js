...
export class StaffMutePacket extends OneWayPacket {
	static PACKET_ID = PacketIds.STAFF_MUTE;

	verifyHandle() {
		const data = this.getPacketData();
		return data.player !== undefined && data.by !== undefined && data.length !== undefined && data.reason !== undefined;
	}
